...
def main():
    ...
    text = (
        ...
        f"At D3=0 this is invisible (state-3 is free, so mincut finds E=0 using 38 state-3\n"
        f"sites to route around the obstruction) -- but for ANY D3>0 those 38 sites cost\n"
        f"real energy, and SA confirms a genuine, unavoidable floor (E<={best_e:.0f} at D3=1,\n"
        f"better than naive hub-fixed's 38 but still far above 0; saturates at E=56 for D3>=2).\n\n"
