...
D = (0.0, 0.0, D3)
SIZES = [6, 8, 10, 14]
T_GRID = [round(1.10 + 0.03 * k, 3) for k in range(11)]  # 1.10 .. 1.40, bracketing
                                                          # the scoping scan's drop at ~1.25-1.30
...
def scan():
    ...
    for L in SIZES:
        ...
        for T in T_GRID:
            ...
            per_T[T] = {**r, "U": U}
            results[L] = per_T
            with open("hub_rim_Tc_finite_size_D3_10.pkl", "wb") as f:
                pickle.dump(results, f)
    print("saved hub_rim_Tc_finite_size_D3_10.pkl")
