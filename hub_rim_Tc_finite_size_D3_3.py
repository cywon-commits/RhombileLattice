...
D = (0.0, 0.0, D3)
SIZES = [6, 8, 10, 14]
T_GRID = [round(0.85 + 0.05 * k, 3) for k in range(11)]  # 0.85 .. 1.35, bracketing the
                                                          # earlier single-size T_c(D3=3)~1.07
...
def scan():
    ...
    for L in SIZES:
        ...
        for T in T_GRID:
            ...
            per_T[T] = {**r, "U": U}
            results[L] = per_T
            with open("hub_rim_Tc_finite_size_D3_3.pkl", "wb") as f:
                pickle.dump(results, f)
    print("saved hub_rim_Tc_finite_size_D3_3.pkl")
